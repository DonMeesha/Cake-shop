                ...
                <div class="container-fluid">
                    ...
                    <div class="modal fade" id="addCakeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>Name</label>
                                <input type="text" name="cake_name" class="form-control" placeholder="Enter Name.." required>
                            </div>
                            
                            <div class="form-group">
                                <label>weight</label>
                                <input type="text" name="cake_weight" class="form-control" placeholder="Enter weight.." required>
                            </div>
                            
                            <div class="form-group">
                                <label>Price</label>
                                <input type="text" name="cake_price" class="form-control" placeholder="Enter Price.." required>
                            </div>
                            
                            <div class="form-group">
                                <label>description</label>
                                <input type="text" name="cake_description" class="form-control" placeholder="Enter Description.." required>
                            </div>

                            
                                <label>Upload Image</label>
                                <input type="file" class="form-control-file" name="cake_image" id="cake_image" required>
                        </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" name="save_cake" class="btn btn-primary">Save</button>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="card-shadow mb-4">
                            <h4 class="n-0 font-weight-bold text-prmary">New Cakes</h4>
                                        ...
                                        while($row = mysqli_fetch_assoc($query_run))
                                {
                                    ?>
                                     <tr>
                                            ...
                                            <td><?php echo '<img src ="uploads/'.$row['image'].'" width="100px;" height="100px;" alt="cakes">' ?>
                                            </td>
                                            
                                            <td> 
                                            <form action="addcakes_edit.php" method="post">
                                            ...
                                            <form action="code.php" method="post">
                                                ...
                                                <button type="submit" name="addcake_delete_btn" class="btn btn-danger">DELETE</button>
                                            </form>
                                            </td>
